...
Uses corrected meeting IDs that match the Granola cache.
"""
...
def main():
    ...
    # Batch 3 meeting IDs (21-26 of 26) - CORRECTED IDs from cache
    meeting_data = [
        ...
        ("8d3f3175-a87d-4360-87dc-61825d1eb661", "Professional services enablement"),
        ("321d5826-561e-43b7-9157-0ce00df5731f", "Command of message framework"),
    ...
    print(f"Fetching Batch 3 ({len(meeting_data)} meetings) from Granola...")
    print()
    ...
    for i, (meeting_id, description) in enumerate(meeting_data, start=21):
        try:
    ...
    print()
    print("=" * 80)
    print(f"Results: Successfully saved {len(saved_files)} of {len(meeting_data)} meeting files")
