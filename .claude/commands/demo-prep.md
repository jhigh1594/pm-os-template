...
**Arguments**:
- `--product`: `agileplace | roadmaps | dpd | platform` — if omitted, inferred from scenario or asked
...
/demo-prep --product agileplace --duration 20 "CS renewal call with champion who hasn't driven exec adoption"
