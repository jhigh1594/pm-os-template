...
**Examples:**
- "I need to recreate this [product] board view as an interactive Figma prototype for stakeholder validation"
...
Example requests:
- "Recreate this product screenshot as an interactive Figma prototype"
