...
### In-Flight Delivery Triage

When a sprint or release is off-track, focus on three questions:

1. **What's at risk?** — The 1-3 items that determine whether the milestone is hit
2. **What are the 3 moves that matter?** — Actions that either unblock progress or reduce scope cleanly
3. **Who needs to know?** — Who to tell, when, and how to frame it

**Triage rules:**
- Don't optimize for looking good — name what's actually at risk
- Scope creep is often the unstated reason for delays; surface it explicitly
- Announce delays early: a delay surfaced early is a planning adjustment; surfaced late it's a failure
- Stakeholder template: "We're going to miss [date] on [item] because [specific reason]. Here's what we're doing about it."

**When to triage:** Before any stakeholder update, or any time something feels off.
...
### Limited Availability → General Availability (B2B)

**When to use**: Feature is ready but needs controlled rollout — typically for enterprise features requiring field enablement, or when CSM/sales needs to guide initial accounts.

**Limited Availability (LA):**
1. Define LA eligibility: specific accounts, segments, or opt-in
2. Complete sales enablement: talk track, objection handling, demo guide
3. Internal enablement: support team trained, escalation path documented
4. Set LA metrics and graduation criteria before opening to all

**LA → GA graduation checklist:**
- [ ] LA adoption/activation metrics hit threshold
- [ ] Sales can confidently demo and handle objections
- [ ] Support can handle increased volume at GA scale
- [ ] No critical bugs in LA cohort
- [ ] Pricing/packaging finalized (if applicable)

**GA announcement:** Coordinate `/write --type announcement` with field team timing — GA comms to customers should land after sales has been briefed, not before.
