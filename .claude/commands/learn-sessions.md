...
Manually reviews recent `.specstory/history/` sessions and extracts patterns worth preserving to `🤖 AI/patterns/learned-patterns.md`.
...
Adds entries to `🤖 AI/patterns/learned-patterns.md` that pass the 4-gate quality filter:
...
4. Append survivors to the appropriate section of `🤖 AI/patterns/learned-patterns.md`
